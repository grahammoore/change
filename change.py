...
def calculatechangeformat(change):
    ...
    change = subtract_coin_or_note(change, "£10", "20")
    change = subtract_coin_or_note(change, "£5", "20")
    change = subtract_coin_or_note(change, "£2", "20")
    change = subtract_coin_or_note(change, "£1", "20")
    change = subtract_coin_or_note(change, "50p", "20")
    change = subtract_coin_or_note(change, "20p", "20")
    change = subtract_coin_or_note(change, "10p", "20")
    change = subtract_coin_or_note(change, "5p", "20")
    change = subtract_coin_or_note(change, "2p", "20")
    change = subtract_coin_or_note(change, "1p", "20")
